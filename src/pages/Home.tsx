...
const Home = () => {
  ...
  const { unreadCounts, totalUnread, requestPermission, permissionGranted } = useNotificationContext();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="h-14 flex items-center justify-between px-4 border-b border-border bg-card sidebar-shadow pt-safe py-[2px]">
        ...
        <div className="flex items-center gap-2">
          {!permissionGranted && (
            <Button variant="ghost" size="sm" onClick={handleEnableNotifications} title="Enable notifications">
              <BellOff className="w-4 h-4" />
            </Button>
          )}
          {permissionGranted && (
            <Button variant="ghost" size="sm" className="text-primary" title="Notifications enabled">
              ...
              {friends.map(friend => {
                ...
                return (
                  <div 
                    ...
                    className="bg-card border border-border rounded-lg p-4 cursor-pointer smooth-transition hover:bg-accent/50 hover:scale-105 hover:shadow-lg px-[18px] py-0"
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      {unreadCount > 0 && (
                        <div className="bg-destructive text-destructive-foreground text-xs px-2 py-1 rounded-full font-medium animate-pulse">
